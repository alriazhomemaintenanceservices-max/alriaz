...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://saudihomeexperts.com/سباك-aqiq`,
    languages: {
      'ar-SA': `https://saudihomeexperts.com/سباك-aqiq`,
      'en': `https://saudihomeexperts.com/plumber-aqiq`
    }
  },
  openGraph: {
    ...
    url: `https://saudihomeexperts.com/سباك-aqiq`,
...
export default function PlumberAlAqiqPage() {
