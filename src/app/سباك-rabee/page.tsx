...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://saudihomeexperts.com/سباك-rabee`,
    languages: {
      'ar-SA': `https://saudihomeexperts.com/سباك-rabee`,
      'en': `https://saudihomeexperts.com/plumber-rabee`
    }
  },
  openGraph: {
    ...
    url: `https://saudihomeexperts.com/سباك-rabee`,
