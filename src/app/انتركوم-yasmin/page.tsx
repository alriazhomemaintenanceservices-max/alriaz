...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://saudihomeexperts.com/انتركوم-yasmin`,
    languages: {
      'ar-SA': `https://saudihomeexperts.com/انتركوم-yasmin`,
      'en': `https://saudihomeexperts.com/intercom-yasmin`
    }
  },
  openGraph: {
    ...
    url: `https://saudihomeexperts.com/انتركوم-yasmin`,
...
export default function IntercomAlYasminPage() {
