...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://saudihomeexperts.com/سباك-falah`,
    languages: {
      'ar-SA': `https://saudihomeexperts.com/سباك-falah`,
      'en': `https://saudihomeexperts.com/plumber-falah`
    }
  },
  openGraph: {
    ...
    url: `https://saudihomeexperts.com/سباك-falah`,
