...
export const metadata: Metadata = {
    title: "Best Plumber in Buraidah | Licensed Plumber Service",
    description: "Expert plumber in Buraidah. Specialized in leak detection, pipe repair & tank cleaning. 24/7 service, fair pricing, and professional techniques.",
    alternates: {
        canonical: "https://saudihomeexperts.com/plumber-buraidah",
        languages: {
            'ar-SA': "https://saudihomeexperts.com/ar/plumber-buraidah"
        }
    }
};

export default function PlumberBuraidahPage() {
    ...
    return (
        <main style={{ paddingTop: '100px', lineHeight: '1.8', color: '#1e293b' }}>
            <nav className="container" style={{ marginBottom: '30px', fontSize: '0.9rem', color: 'var(--muted)', display: 'flex', justifyContent: 'space-between' }}>
                <div><Link href="/">Home</Link> / <Link href="/services">Services</Link> / <span style={{ color: 'var(--primary)', fontWeight: 600 }}>Plumber Buraidah</span></div>
                <div style={{ display: 'flex', gap: '15px' }}>
                    <Link href="/plumber-buraidah" style={{ fontWeight: 800, color: 'var(--primary)', borderBottom: '2px solid' }}>English</Link>
                    <Link href="/ar/plumber-buraidah" style={{ fontWeight: 500 }}>العربية</Link>
                </div>
            </nav>
                    ...
                    <div className="grid grid-2" style={{ alignItems: 'center', gap: '60px' }}>
                        <div>
                            ...
                            <h1 style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', lineHeight: 1.1, letterSpacing: '-0.02em', marginBottom: '24px', color: '#0f172a' }}>
                                Expert Plumber in Buraidah
                            </h1>
                            <p style={{ fontSize: '1.2rem', color: '#444', marginBottom: '40px', maxWidth: '600px' }}>
                                Looking for a professional <strong>plumber</strong> in Buraidah? Saudi Home Experts provides top-rated maintenance for villas, apartments, and commercial properties.
                            </p>
                ...
                <div className="container" style={{ maxWidth: '900px' }}>
                    ...
                    <div style={{ display: 'grid', gap: '30px' }}>
                        ...
                        <div style={{ background: '#f8fafc', padding: '35px', borderRadius: '24px', border: '1px solid #e2e8f0' }}>
                            <h3 style={{ fontSize: '1.3rem', marginBottom: '15px', color: '#0f172a', fontWeight: 800 }}>How much does a plumber cost in Buraidah?</h3>
                            <p style={{ color: '#444', fontSize: '1.1rem' }}>Most repairs in Buraidah start from SAR 150. Transparent pricing based on parts and labor.</p>
                        </div>
                    </div>
                </div>
            </section>
