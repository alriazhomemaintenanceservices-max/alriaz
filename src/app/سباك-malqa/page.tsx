...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://saudihomeexperts.com/سباك-malqa`,
    languages: {
      'ar-SA': `https://saudihomeexperts.com/سباك-malqa`,
      'en': `https://saudihomeexperts.com/plumber-malqa`
    }
  },
  openGraph: {
    ...
    url: `https://saudihomeexperts.com/سباك-malqa`,
...
export default function PlumberAlMalqaPage() {
