...
const area = { name: 'الربيع', slug: 'rabee', english: 'Al-Rabee' };
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://saudihomeexperts.com/انتركوم-rabee`,
    languages: {
      'ar-SA': `https://saudihomeexperts.com/انتركوم-rabee`,
      'en': `https://saudihomeexperts.com/intercom-rabee`
    }
  },
  openGraph: {
    ...
    url: `https://saudihomeexperts.com/انتركوم-rabee`,
...
export default function IntercomAlRabeePage() {
