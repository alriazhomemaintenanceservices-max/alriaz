...
export const metadata: Metadata = {
    title: {
        absolute: "Intercom Installation in Al Yasmin, Riyadh | Smart Villa Security"
    },
    alternates: {
        canonical: '/riyadh/yasmin/intercom/'
    },
    description: "Smart intercom installation & repair in Al Yasmin, Riyadh City. Video doorbells, multi-apartment systems, and mobile app integration by Saudi Home Experts specialist.",
};

export default function IntercomYasminPage() {
    return (
        <main style={{ paddingTop: '100px', lineHeight: '1.8', color: '#1e293b' }}>
            ...
            <nav className="container" style={{ marginBottom: '30px', fontSize: '0.9rem', color: 'var(--muted)' }}>
                <Link href="/">Home</Link> / <Link href="/services">Services</Link> / <Link href="/services/intercom">Intercom</Link> / <span style={{ color: 'var(--primary)', fontWeight: 600 }}>Yasmin</span>
            </nav>
                    ...
                    <div className="grid grid-2" style={{ alignItems: 'center', gap: '80px' }}>
                        <div>
                            ...
                            <h1 style={{ fontSize: 'clamp(2.8rem, 6vw, 4.5rem)', lineHeight: 1, letterSpacing: '-0.02em', marginBottom: '24px', color: '#0f172a' }}>
                                Licensed <span style={{ color: 'var(--primary)' }}>Intercom in Al Yasmin</span>, Riyadh — Fast 24/7 Support
                            </h1>
                            <p style={{ fontSize: '1.3rem', color: '#444', marginBottom: '40px', maxWidth: '600px' }}>
                                Experiencing a maintenance emergency in Al Yasmin? Saudi Home Experts provides elite-level intercom services for luxury villas and prestigious apartments accessible via Anas Bin Malik Road and Northern Ring Road. Join 15,000+ satisfied clients across Riyadh who trust us for safety and precision.
                            </p>
                            <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap' }}>
                                <a href="https://wa.me/966508901536?text=I%20need%20an%20expert%20intercom%20in%20Al Yasmin%20Riyadh" target="_blank" rel="noopener noreferrer" className="btn btn-primary" style={{ background: '#22c55e', border: 'none', padding: '18px 40px', fontSize: '1.1rem', boxShadow: '0 10px 15px -3px rgba(34, 197, 94, 0.4)' }}>
                        ...
                        <div style={{ position: 'relative' }}>
                            <div style={{ background: 'white', padding: '50px', borderRadius: '40px', border: '1px solid var(--border)', boxShadow: '0 25px 50px -12px rgba(0,0,0,0.08)' }}>
                                ...
                                <p style={{ fontSize: '1.05rem', color: '#64748b', marginBottom: '25px' }}>
                                    Our Intercom experts in Al Yasmin are rigorously vetted. We handle specialized electrical architectures of high-end Riyadh villas with absolute professionalism.
                                </p>
            ...
            <section className="section animate-fade-in" style={{ background: '#f8fafc' }}>
                <div className="container">
                    <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto 60px' }}>
                        <h2 style={{ fontSize: '2.5rem', marginBottom: '20px' }}>Comprehensive Intercom Solutions for Al Yasmin Homes</h2>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '30px' }}>
                        ...
                        <div className="card hover-lift" style={{ padding: '30px', background: 'white', borderRadius: '24px', transition: 'transform 0.3s ease' }}>
                            ...
                            <p style={{ fontSize: '0.95rem', color: '#64748b' }}>Professional handling of Smart Video Intercom Installation in the Al Yasmin area, ensuring full compliance with Saudi Electrical & Building codes (SASO).</p>
                        </div>
                        ...
                        <div className="card hover-lift" style={{ padding: '30px', background: 'white', borderRadius: '24px', transition: 'transform 0.3s ease' }}>
                            ...
                            <p style={{ fontSize: '0.95rem', color: '#64748b' }}>Professional handling of Multi-Floor Apartment Solutions in the Al Yasmin area, ensuring full compliance with Saudi Electrical & Building codes (SASO).</p>
                        </div>
                        ...
                        <div className="card hover-lift" style={{ padding: '30px', background: 'white', borderRadius: '24px', transition: 'transform 0.3s ease' }}>
                            ...
                            <p style={{ fontSize: '0.95rem', color: '#64748b' }}>Professional handling of Mobile App Integration in the Al Yasmin area, ensuring full compliance with Saudi Electrical & Building codes (SASO).</p>
                        </div>
                        ...
                        <div className="card hover-lift" style={{ padding: '30px', background: 'white', borderRadius: '24px', transition: 'transform 0.3s ease' }}>
                            ...
                            <p style={{ fontSize: '0.95rem', color: '#64748b' }}>Professional handling of Wiring & Connectivity Repair in the Al Yasmin area, ensuring full compliance with Saudi Electrical & Building codes (SASO).</p>
                        </div>
                        ...
                        <div className="card hover-lift" style={{ padding: '30px', background: 'white', borderRadius: '24px', transition: 'transform 0.3s ease' }}>
                            ...
                            <p style={{ fontSize: '0.95rem', color: '#64748b' }}>Professional handling of Villa Gate Communication Systems in the Al Yasmin area, ensuring full compliance with Saudi Electrical & Building codes (SASO).</p>
                        </div>
                        ...
                        <div className="card hover-lift" style={{ padding: '30px', background: 'white', borderRadius: '24px', transition: 'transform 0.3s ease' }}>
                            ...
                            <p style={{ fontSize: '0.95rem', color: '#64748b' }}>Professional handling of Night Vision Camera Integration in the Al Yasmin area, ensuring full compliance with Saudi Electrical & Building codes (SASO).</p>
                        </div>
                        ...
                        <div className="card hover-lift" style={{ padding: '30px', background: 'white', borderRadius: '24px', transition: 'transform 0.3s ease' }}>
                            ...
                            <p style={{ fontSize: '0.95rem', color: '#64748b' }}>Professional handling of Biometric Access Control in the Al Yasmin area, ensuring full compliance with Saudi Electrical & Building codes (SASO).</p>
                        </div>
                        ...
                        <div className="card hover-lift" style={{ padding: '30px', background: 'white', borderRadius: '24px', transition: 'transform 0.3s ease' }}>
                            ...
                            <p style={{ fontSize: '0.95rem', color: '#64748b' }}>Professional handling of Wireless Doorbell Setup in the Al Yasmin area, ensuring full compliance with Saudi Electrical & Building codes (SASO).</p>
                        </div>
                        ...
                        <div className="card hover-lift" style={{ padding: '30px', background: 'white', borderRadius: '24px', transition: 'transform 0.3s ease' }}>
                            ...
                            <p style={{ fontSize: '0.95rem', color: '#64748b' }}>Professional handling of IP Intercom Configuration in the Al Yasmin area, ensuring full compliance with Saudi Electrical & Building codes (SASO).</p>
                        </div>
                        ...
                        <div className="card hover-lift" style={{ padding: '30px', background: 'white', borderRadius: '24px', transition: 'transform 0.3s ease' }}>
                            ...
                            <p style={{ fontSize: '0.95rem', color: '#64748b' }}>Professional handling of Old System Modernization in the Al Yasmin area, ensuring full compliance with Saudi Electrical & Building codes (SASO).</p>
                        </div>
                        ...
                        <div className="card hover-lift" style={{ padding: '30px', background: 'white', borderRadius: '24px', transition: 'transform 0.3s ease' }}>
                            ...
                            <p style={{ fontSize: '0.95rem', color: '#64748b' }}>Professional handling of Voice Recognition Intercoms in the Al Yasmin area, ensuring full compliance with Saudi Electrical & Building codes (SASO).</p>
                        </div>
                        ...
                        <div style={{ background: '#0f172a', color: 'white', padding: '60px', borderRadius: '40px', boxShadow: '0 30px 60px -15px rgba(15,23,42,0.3)' }}>
                            ...
                            <div className="grid grid-2" style={{ gap: '40px' }}>
                                ...
                                <div>
                                    ...
                                    <p style={{ fontSize: '0.95rem', opacity: 0.8 }}>Our dispatch center near Northern Ring Road ensures that an expert intercom in Al Yasmin is never more than 40 minutes away from any emergency call.</p>
                                </div>
                            </div>
                            ...
                            <div style={{ marginTop: '40px', borderTop: '1px dotted rgba(255,255,255,0.2)', paddingTop: '30px', display: 'flex', flexWrap: 'wrap', gap: '15px', justifyContent: 'center' }}>
                                <Link href="/riyadh/sahafa/electrician" style={{ color: 'var(--primary)', fontWeight: 600 }}>Emergency electrician in Al Sahafah</Link>
                                <span style={{ opacity: 0.3 }}>|</span>
                                <Link href="/riyadh/falah/plumber" style={{ color: 'var(--primary)', fontWeight: 600 }}>Reliable plumber for Al Falah Villas</Link>
                                <span style={{ opacity: 0.3 }}>|</span>
                                <Link href="/riyadh/granada/intercom" style={{ color: 'var(--primary)', fontWeight: 600 }}>Best intercom in Granada</Link>
                                <span style={{ opacity: 0.3 }}>|</span>
                                <Link href="/riyadh/rabee/electrician" style={{ color: 'var(--primary)', fontWeight: 600 }}>Verified electrician Al Rabee</Link>
                                <span style={{ opacity: 0.3 }}>|</span>
                                <Link href="/riyadh/nada/plumber" style={{ color: 'var(--primary)', fontWeight: 600 }}>Top-rated plumber Unit in Al Nada</Link>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="section animate-fade-in" style={{ background: '#fdfdfd' }}>
                <div className="container" style={{ maxWidth: '850px' }}>
                    ...
                    <div style={{ display: 'grid', gap: '16px' }}>
                        {[
                            { q: "How quickly can an Saudi Home Experts intercom arrive in Al Yasmin?", a: "With our dedicated response unit stationed near Al Yasmin, we typically reach your villa within 35 to 45 minutes for emergency calls." },
            ...
            <section className="section animate-fade-in" style={{ textAlign: 'center' }}>
                <div className="container">
                    <div style={{ background: 'var(--primary)', color: 'white', padding: '80px 40px', borderRadius: '40px', position: 'relative', overflow: 'hidden' }}>
                        <h2 style={{ fontSize: '3rem', marginBottom: '20px', position: 'relative', zIndex: 1 }}>Professional Intercom in Al Yasmin</h2>
                        ...
                        <a href="https://wa.me/966508901536?text=I%20need%20an%20expert%20intercom%20in%20Al Yasmin%20Riyadh" target="_blank" rel="noopener noreferrer" className="btn" style={{ background: '#22c55e', color: 'white', border: 'none', padding: '20px 60px', fontSize: '1.4rem', borderRadius: '100px', fontWeight: 700, boxShadow: '0 20px 40px -10px rgba(0,0,0,0.2)', position: 'relative', zIndex: 1 }}>
