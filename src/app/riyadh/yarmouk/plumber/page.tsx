...
export const metadata: Metadata = {
    ...
    description: "Expert plumber in Al Yarmouk, Riyadh City. 24/7 emergency leak detection, water tank cleaning, pipe repair, and heater installation. High-quality Al Riaz service.",
};
                    ...
                    <div className="grid grid-2" style={{ alignItems: 'center', gap: '80px' }}>
                        <div>
                            ...
                            <p style={{ fontSize: '1.3rem', color: '#444', marginBottom: '40px', maxWidth: '600px' }}>
                                Experiencing a maintenance emergency in Al Yarmouk? Al Riaz Home Maintenance provides elite-level plumber services for luxury villas and prestigious apartments close to the metro tracks and Prince Bandar Road. Join 15,000+ satisfied clients across Riyadh who trust us for safety and precision.
                            </p>
            ...
            <section className="section animate-fade-in" style={{ background: '#fdfdfd' }}>
                <div className="container" style={{ maxWidth: '850px' }}>
                    ...
                    <div style={{ display: 'grid', gap: '16px' }}>
                        {[
                            { q: "How quickly can an Al Riaz plumber arrive in Al Yarmouk?", a: "With our dedicated response unit stationed near Al Yarmouk, we typically reach your villa within 35 to 45 minutes for emergency calls." },
