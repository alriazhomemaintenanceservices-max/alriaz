...
export const metadata: Metadata = {
    ...
    description: "Certified electrician in Al Narjis, Riyadh City. 24/7 emergency electrical fixes, villa rewiring, DB box maintenance, and lighting installation. Al Riaz #1 choice. Book now!",
};
                    ...
                    <div className="grid grid-2" style={{ alignItems: 'center', gap: '80px' }}>
                        <div>
                            ...
                            <p style={{ fontSize: '1.3rem', color: '#444', marginBottom: '40px', maxWidth: '600px' }}>
                                Experiencing a maintenance emergency in Al Narjis? Al Riaz Home Maintenance provides elite-level electrician services for luxury villas and prestigious apartments near King Salman Road and the North Expansion zones. Join 15,000+ satisfied clients across Riyadh who trust us for safety and precision.
                            </p>
            ...
            <section className="section animate-fade-in" style={{ background: '#fdfdfd' }}>
                <div className="container" style={{ maxWidth: '850px' }}>
                    ...
                    <div style={{ display: 'grid', gap: '16px' }}>
                        {[
                            { q: "How quickly can an Al Riaz electrician arrive in Al Narjis?", a: "With our dedicated response unit stationed near Al Narjis, we typically reach your villa within 35 to 45 minutes for emergency calls." },
