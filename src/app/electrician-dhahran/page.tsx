...
export const metadata: Metadata = {
    title: "Best Electrician in Dhahran | Licensed Electrician Service",
    description: "Expert electrician in Dhahran. Specialized in short circuit repair & lighting design. 24/7 service, fair pricing, and professional techniques.",
    alternates: {
        canonical: "https://saudihomeexperts.com/electrician-dhahran",
        languages: {
            'ar-SA': "https://saudihomeexperts.com/ar/electrician-dhahran"
        }
    }
};

export default function ElectricianDhahranPage() {
    const whatsappUrl = "https://wa.me/966508901536?text=I%20need%20Electrician%20service%20in%20Dhahran";
    ...
    return (
        <main style={{ paddingTop: '100px', lineHeight: '1.8', color: '#1e293b' }}>
            <nav className="container" style={{ marginBottom: '30px', fontSize: '0.9rem', color: 'var(--muted)', display: 'flex', justifyContent: 'space-between' }}>
                <div><Link href="/">Home</Link> / <Link href="/services">Services</Link> / <span style={{ color: 'var(--primary)', fontWeight: 600 }}>Electrician Dhahran</span></div>
                <div style={{ display: 'flex', gap: '15px' }}>
                    <Link href="/electrician-dhahran" style={{ fontWeight: 800, color: 'var(--primary)', borderBottom: '2px solid' }}>English</Link>
                    <Link href="/ar/electrician-dhahran" style={{ fontWeight: 500 }}>العربية</Link>
                </div>
            </nav>
                    ...
                    <div className="grid grid-2" style={{ alignItems: 'center', gap: '60px' }}>
                        <div>
                            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '8px 16px', background: '#ecfdf5', color: '#059669', borderRadius: '50px', fontWeight: 600, fontSize: '0.9rem', marginBottom: '20px' }}>
                                <BadgeCheck size={16} /> Licensed Service in Dhahran
                            </div>
                            <h1 style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', lineHeight: 1.1, letterSpacing: '-0.02em', marginBottom: '24px', color: '#0f172a' }}>
                                Expert Electrician in Dhahran
                            </h1>
                            <p style={{ fontSize: '1.2rem', color: '#444', marginBottom: '40px', maxWidth: '600px' }}>
                                Looking for a professional <strong>electrician</strong> in Dhahran? Saudi Home Experts provides top-rated maintenance for villas, apartments, and commercial properties.
                            </p>
                        ...
                        <div style={{ textAlign: 'center' }} className="hide-mobile">
                             <div style={{ background: '#f8fafc', padding: '50px', borderRadius: '40px', border: '1px solid var(--border)' }}>
                                ...
                                <ul style={{ listStyle: 'none', padding: 0, display: 'grid', gap: '20px', color: '#475569', textAlign: 'left' }}>
                                    <li style={{ display: 'flex', gap: '15px', alignItems: 'center' }}><Clock size={24} color="var(--primary)" /> <div>Fast arrival across Dhahran districts.</div></li>
            ...
            <section className="section">
                <div className="container">
                    <h2 style={{ textAlign: 'center', fontSize: '2.5rem', marginBottom: '60px' }}>Comprehensive Solutions in Dhahran</h2>
            ...
            <section className="section" style={{ background: '#f1f5f9' }}>
                <div className="container" style={{ textAlign: 'center' }}>
                    <h2 style={{ fontSize: '2rem', marginBottom: '40px' }}>Districts We Cover in Dhahran</h2>
                ...
                <div className="container" style={{ maxWidth: '900px' }}>
                    ...
                    <div style={{ display: 'grid', gap: '30px' }}>
                        ...
                        <div style={{ background: '#f8fafc', padding: '35px', borderRadius: '24px', border: '1px solid #e2e8f0' }}>
                            <h3 style={{ fontSize: '1.3rem', marginBottom: '15px', color: '#0f172a', fontWeight: 800 }}>Can you fix a short circuit in Dhahran?</h3>
                            <p style={{ color: '#444', fontSize: '1.1rem' }}>Yes, our units specialize in rapid detection in Dhahran.</p>
                        </div>
                    </div>
                </div>
            </section>
