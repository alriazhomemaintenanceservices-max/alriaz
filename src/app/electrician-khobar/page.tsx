...
export const metadata: Metadata = {
    title: "Best Electrician in Khobar | Licensed Electrician Service",
    description: "Expert electrician in Khobar. Specialized in short circuit repair & lighting design. 24/7 service, fair pricing, and professional techniques.",
    alternates: {
        canonical: "https://saudihomeexperts.com/electrician-khobar",
        languages: {
            'ar-SA': "https://saudihomeexperts.com/ar/electrician-khobar"
        }
    }
};

export default function ElectricianKhobarPage() {
    const whatsappUrl = "https://wa.me/966508901536?text=I%20need%20Electrician%20service%20in%20Khobar";
    ...
    return (
        <main style={{ paddingTop: '100px', lineHeight: '1.8', color: '#1e293b' }}>
            <nav className="container" style={{ marginBottom: '30px', fontSize: '0.9rem', color: 'var(--muted)', display: 'flex', justifyContent: 'space-between' }}>
                <div><Link href="/">Home</Link> / <Link href="/services">Services</Link> / <span style={{ color: 'var(--primary)', fontWeight: 600 }}>Electrician Khobar</span></div>
                <div style={{ display: 'flex', gap: '15px' }}>
                    <Link href="/electrician-khobar" style={{ fontWeight: 800, color: 'var(--primary)', borderBottom: '2px solid' }}>English</Link>
                    <Link href="/ar/electrician-khobar" style={{ fontWeight: 500 }}>العربية</Link>
                </div>
            </nav>
                    ...
                    <div className="grid grid-2" style={{ alignItems: 'center', gap: '60px' }}>
                        <div>
                            ...
                            <h1 style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', lineHeight: 1.1, letterSpacing: '-0.02em', marginBottom: '24px', color: '#0f172a' }}>
                                Expert Electrician in Khobar
                            </h1>
                            <p style={{ fontSize: '1.2rem', color: '#444', marginBottom: '40px', maxWidth: '600px' }}>
                                Looking for a professional <strong>electrician</strong> in Khobar? Saudi Home Experts provides top-rated maintenance for villas, apartments, and commercial properties.
                            </p>
                ...
                <div className="container" style={{ maxWidth: '900px' }}>
                    ...
                    <div style={{ display: 'grid', gap: '30px' }}>
                        ...
                        <div style={{ background: '#f8fafc', padding: '35px', borderRadius: '24px', border: '1px solid #e2e8f0' }}>
                            <h3 style={{ fontSize: '1.3rem', marginBottom: '15px', color: '#0f172a', fontWeight: 800 }}>Can you fix a short circuit in Khobar?</h3>
                            <p style={{ color: '#444', fontSize: '1.1rem' }}>Yes, our units specialize in rapid detection in Khobar.</p>
                        </div>
                    </div>
                </div>
            </section>
