...
const area = { name: 'الملقا', slug: 'malqa', english: 'Al-Malqa' };
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://saudihomeexperts.com/انتركوم-malqa`,
    languages: {
      'ar-SA': `https://saudihomeexperts.com/انتركوم-malqa`,
      'en': `https://saudihomeexperts.com/intercom-malqa`
    }
  },
  openGraph: {
    ...
    url: `https://saudihomeexperts.com/انتركوم-malqa`,
...
export default function IntercomAlMalqaPage() {
