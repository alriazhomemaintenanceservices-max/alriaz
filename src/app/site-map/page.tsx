...
const mainPages = [
    ...
    { name: "Electrician Cost Guide", href: "/services/electrician/cost-riyadh/" },
    { name: "Emergency Electrician", href: "/services/electrician/emergency/" },
    { name: "Plumber Service Hub", href: "/services/plumber/" },
    { name: "Plumber Cost Guide", href: "/services/plumber/cost-riyadh/" },
    { name: "Emergency Plumber", href: "/services/plumber/emergency/" },
    { name: "Intercom Service Hub", href: "/services/intercom/" },
    { name: "Intercom Cost Guide", href: "/services/intercom/cost-riyadh/" },
    { name: "FAQ", href: "/faq/" },
    { name: "Blog (Arabic)", href: "/blog/" },
    { name: "Blog (English)", href: "/en/blog/" },
