...
export const metadata: Metadata = {
  title: 'Blog | Saudi Home Experts — Electrician, Plumber & Intercom Tips Riyadh',
  description: 'Home maintenance guides for Riyadh: electrical safety, plumbing fixes, intercom & security tips.',
  alternates: { canonical: '/en/blog/' },
  openGraph: { title: 'Saudi Home Experts Blog', description: 'Home guides for Riyadh.', url: '/en/blog/', type: 'website' },
};
...
export default async function EnBlogListingPage() {
    ...
    <div className="blog-wrap">
      <header className="blog-head">
        <div className="container">
          ...
          <p>Practical electrician, plumbing and intercom guides for Riyadh homes.</p>
        </div>
      </header>
