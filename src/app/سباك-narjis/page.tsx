...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://saudihomeexperts.com/سباك-narjis`,
    languages: {
      'ar-SA': `https://saudihomeexperts.com/سباك-narjis`,
      'en': `https://saudihomeexperts.com/plumber-narjis`
    }
  },
  openGraph: {
    ...
    url: `https://saudihomeexperts.com/سباك-narjis`,
