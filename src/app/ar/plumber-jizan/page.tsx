...
export const metadata: Metadata = {
    title: "سباك في جازان | خدمة سباك معتمدة 24 ساعة",
    description: "أفضل سباك في جازان. متخصصون في leak detection, pipe repair & tank cleaning. خدمة 24 ساعة، قطع غيار أصلية، وأسعار تنافسية. اتصل الآن!",
    alternates: {
        canonical: "https://saudihomeexperts.com/ar/plumber-jizan",
        languages: {
            'en-US': "https://saudihomeexperts.com/plumber-jizan"
        }
    }
};

export default function ArabicPlumberJizanPage() {
    const whatsappUrl = "https://wa.me/966508901536?text=I%20need%20Plumber%20service%20in%20Jizan";
    ...
    return (
        <main dir="rtl" style={{ paddingTop: '100px', lineHeight: '1.8', color: '#1e293b', fontFamily: 'var(--font-cairo)' }}>
            <nav className="container" style={{ marginBottom: '30px', fontSize: '0.9rem', color: 'var(--muted)', display: 'flex', justifyContent: 'space-between' }}>
                <div><Link href="/ar">الرئيسية</Link> / <Link href="/ar/services">الخدمات</Link> / <span style={{ color: 'var(--primary)', fontWeight: 600 }}>سباك جازان</span></div>
                <div style={{ display: 'flex', gap: '15px' }}>
                    <Link href="/plumber-jizan" style={{ fontWeight: 500 }}>English</Link>
                    <Link href="/ar/plumber-jizan" style={{ fontWeight: 800, color: 'var(--primary)', borderBottom: '2px solid' }}>العربية</Link>
                </div>
            </nav>
                    ...
                    <div className="grid grid-2" style={{ alignItems: 'center', gap: '60px' }}>
                        <div>
                            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '8px 16px', background: '#ecfdf5', color: '#059669', borderRadius: '50px', fontWeight: 600, fontSize: '0.9rem', marginBottom: '20px' }}>
                                <BadgeCheck size={16} /> خدمة معتمدة في جازان
                            </div>
                            ...
                            <p style={{ fontSize: '1.2rem', color: '#444', marginBottom: '40px', maxWidth: '600px' }}>
                                هل تبحث عن <strong>سباك ممتاز</strong> في جازان؟ نوفر خدمات صيانة واحترافية للفلل والشقق والمباني التجارية مع ضمان الجودة.
                            </p>
                        ...
                        <div style={{ textAlign: 'center' }} className="hide-mobile">
                             <div style={{ background: '#f8fafc', padding: '50px', borderRadius: '40px', border: '1px solid var(--border)' }}>
                                ...
                                <ul style={{ listStyle: 'none', padding: 0, display: 'grid', gap: '20px', color: '#475569', textAlign: 'right' }}>
                                    <li style={{ display: 'flex', gap: '15px', alignItems: 'center' }}><Clock size={24} color="var(--primary)" /> <div>وصول سريع لجميع أحياء جازان.</div></li>
            ...
            <section className="section">
                <div className="container">
                    <h2 style={{ textAlign: 'center', fontSize: '2.5rem', marginBottom: '60px' }}>حلول متكاملة في جازان</h2>
            ...
            <section className="section" style={{ background: '#f1f5f9' }}>
                <div className="container" style={{ textAlign: 'center' }}>
                    <h2 style={{ fontSize: '2rem', marginBottom: '40px' }}>الأحياء المشمولة في جازان</h2>
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '15px', justifyContent: 'center' }}>
                        <span style={{ background: 'white', border: '1px solid #e2e8f0', padding: '12px 30px', borderRadius: '50px', fontWeight: 600 }}>Al-Rawthah</span><span style={{ background: 'white', border: '1px solid #e2e8f0', padding: '12px 30px', borderRadius: '50px', fontWeight: 600 }}>Al-Shati</span><span style={{ background: 'white', border: '1px solid #e2e8f0', padding: '12px 30px', borderRadius: '50px', fontWeight: 600 }}>Al-Matar</span>
                    </div>
                </div>
            </section>
                ...
                <div className="container" style={{ maxWidth: '900px' }}>
                    ...
                    <div style={{ display: 'grid', gap: '30px' }}>
                        ...
                        <div style={{ background: '#f8fafc', padding: '35px', borderRadius: '24px', border: '1px solid #e2e8f0' }}>
                            <h3 style={{ fontSize: '1.3rem', marginBottom: '15px', color: '#0f172a', fontWeight: 800 }}>كم تكلفة السباك في جازان؟</h3>
                            <p style={{ color: '#444', fontSize: '1.1rem' }}>تبدأ معظم الإصلاحات في جازان من 150 ريال سعودي. تسعير شفاف بناءً على قطع الغيار والعمالة.</p>
                        </div>
                    </div>
                </div>
            </section>
