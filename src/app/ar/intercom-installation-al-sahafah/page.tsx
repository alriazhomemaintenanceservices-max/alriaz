...
export const metadata: Metadata = {
    title: "تركيب انتركم في الصحافة | خدمة تركيب انتركم معتمدة 24 ساعة",
    description: "أفضل تركيب انتركم في الصحافة. متخصصون في video intercom, ip systems & access control. خدمة 24 ساعة، قطع غيار أصلية، وأسعار تنافسية. اتصل الآن!",
    alternates: {
        canonical: "https://saudihomeexperts.com/ar/intercom-installation-al-sahafah",
        languages: {
            'en-US': "https://saudihomeexperts.com/intercom-installation-al-sahafah"
        }
    }
};

export default function ArabicIntercomInstallationAlSahafahPage() {
    ...
    return (
        <main dir="rtl" style={{ paddingTop: '100px', lineHeight: '1.8', color: '#1e293b', fontFamily: 'var(--font-cairo)' }}>
            <nav className="container" style={{ marginBottom: '30px', fontSize: '0.9rem', color: 'var(--muted)', display: 'flex', justifyContent: 'space-between' }}>
                <div><Link href="/ar">الرئيسية</Link> / <Link href="/ar/services">الخدمات</Link> / <span style={{ color: 'var(--primary)', fontWeight: 600 }}>تركيب انتركم الصحافة</span></div>
                <div style={{ display: 'flex', gap: '15px' }}>
                    <Link href="/intercom-installation-al-sahafah" style={{ fontWeight: 500 }}>English</Link>
                    <Link href="/ar/intercom-installation-al-sahafah" style={{ fontWeight: 800, color: 'var(--primary)', borderBottom: '2px solid' }}>العربية</Link>
                </div>
            </nav>
                    ...
                    <div className="grid grid-2" style={{ alignItems: 'center', gap: '60px' }}>
                        <div>
                            ...
                            <h1 style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', lineHeight: 1.1, letterSpacing: '-0.02em', marginBottom: '24px', color: '#0f172a' }}>
                                أفضل تركيب انتركم في الصحافة
                                
                            </h1>
                            <p style={{ fontSize: '1.2rem', color: '#444', marginBottom: '40px', maxWidth: '600px' }}>
                                هل تبحث عن <strong>تركيب انتركم ممتاز</strong> في الصحافة؟ نوفر خدمات صيانة واحترافية للفلل والشقق والمباني التجارية مع ضمان الجودة.
                            </p>
                ...
                <div className="container" style={{ maxWidth: '900px' }}>
                    ...
                    <div style={{ display: 'grid', gap: '30px' }}>
                        ...
                        <div style={{ background: '#f8fafc', padding: '35px', borderRadius: '24px', border: '1px solid #e2e8f0' }}>
                            <h3 style={{ fontSize: '1.3rem', marginBottom: '15px', color: '#0f172a', fontWeight: 800 }}>ما هي الماركات التي تقوم بتركيبها في الصحافة؟</h3>
