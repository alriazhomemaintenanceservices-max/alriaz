...
const area = { name: 'الحي السادس', slug: 'sadis', english: 'Al-Hay Al-Sadis' };
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://saudihomeexperts.com/انتركوم-${area.slug}`,
    languages: {
      'ar-SA': `https://saudihomeexperts.com/انتركوم-${area.slug}`,
      'en': `https://saudihomeexperts.com/intercom-${area.slug}`
    }
  },
  openGraph: {
    ...
    url: `https://saudihomeexperts.com/انتركوم-${area.slug}`,
...
export default function IntercomSadisPage() {
