...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://saudihomeexperts.com/سباك-hittin`,
    languages: {
      'ar-SA': `https://saudihomeexperts.com/سباك-hittin`,
      'en': `https://saudihomeexperts.com/plumber-hittin`
    }
  },
  openGraph: {
    ...
    url: `https://saudihomeexperts.com/سباك-hittin`,
...
export default function PlumberHittinPage() {
