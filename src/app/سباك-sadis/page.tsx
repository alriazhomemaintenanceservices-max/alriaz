...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://saudihomeexperts.com/سباك-${area.slug}`,
    languages: {
      'ar-SA': `https://saudihomeexperts.com/سباك-${area.slug}`,
  ...
  openGraph: {
    ...
    url: `https://saudihomeexperts.com/سباك-${area.slug}`,
...
export default function PlumberSadisPage() {
