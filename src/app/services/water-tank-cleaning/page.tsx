            ...
            <section style={{ padding: '60px 0', background: '#F8FAFC' }}>
                <div className="container">
                    ...
                    <div className="grid grid-3" style={{ gap: '30px' }}>
                        {[
                            { title: "Sludge Extraction", img: "https://images.unsplash.com/photo-1616664973347-1c4b77f98889?auto=format&fit=crop&q=80&w=2070" },
                            { title: "High-Pressure Scrub", img: "https://plus.unsplash.com/premium_photo-1661331899539-725aa26487e4?auto=format&fit=crop&q=80&w=2070" },
                            { title: "UV/Chlorine Sanitization", img: "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&q=80&w=2070" }
                        ].map((service, i) => (
                ...
                <div className="container">
                    <div className="grid grid-2" style={{ alignItems: 'center', gap: '60px' }}>
                        ...
                        <div style={{ borderRadius: '20px', overflow: 'hidden', boxShadow: '0 20px 40px rgba(0,0,0,0.1)' }}>
                            <img src="https://images.unsplash.com/photo-1603712725038-e9334ade8fc3?auto=format&fit=crop&q=80&w=2070" style={{ width: '100%', display: 'block' }} alt="Clean Water" />
                        </div>
                    </div>
                </div>
            </section>
