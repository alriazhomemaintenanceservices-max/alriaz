...
const area = { name: 'العقيق', slug: 'aqiq', english: 'Al-Aqiq' };
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://saudihomeexperts.com/انتركوم-aqiq`,
    languages: {
      'ar-SA': `https://saudihomeexperts.com/انتركوم-aqiq`,
      'en': `https://saudihomeexperts.com/intercom-aqiq`
    }
  },
  openGraph: {
    ...
    url: `https://saudihomeexperts.com/انتركوم-aqiq`,
...
export default function IntercomAlAqiqPage() {
