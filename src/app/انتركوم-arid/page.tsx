...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://saudihomeexperts.com/انتركوم-arid`,
    languages: {
      'ar-SA': `https://saudihomeexperts.com/انتركوم-arid`,
      'en': `https://saudihomeexperts.com/intercom-arid`
    }
  },
  openGraph: {
    ...
    url: `https://saudihomeexperts.com/انتركوم-arid`,
...
export default function IntercomAlAridPage() {
